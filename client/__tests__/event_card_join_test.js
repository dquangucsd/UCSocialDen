...
import EventDetails from "../components/EventCard"; // Adjust path based on your structure
...
describe("EventDetails - Join Button Functionality", () => {
    const eventMock = {
        ...
        participants: ["user1", "user2"], // Example participant IDs
        participant_limit: 10, // Example limit
      };
